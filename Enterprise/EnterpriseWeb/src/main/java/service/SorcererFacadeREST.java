...
public class SorcererFacadeREST extends AbstractFacade<Sorcerer> {
    ...
    public void create(Sorcerer entity) {
        super.create(entity);
    }
    ...
    @Path("{id}")
    @Consumes({"application/xml", "application/json"})
    public void edit(@PathParam("id") Integer id, Sorcerer entity) {
        super.edit(entity);
    }
    ...
    public Sorcerer find(@PathParam("id") Integer id) {
    ...
    @Path("{from}/{to}")
    @Produces({"application/xml", "application/json"})
    public List<Sorcerer> findRange(@PathParam("from") Integer from, @PathParam("to") Integer to) {
